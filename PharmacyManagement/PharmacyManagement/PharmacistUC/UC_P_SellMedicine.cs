...
namespace PharmacyManagement.PharmacistUC
{
    public partial class UC_P_SellMedicine : UserControl
    {
        ...
        {/*
            ...
            query = "select mnname from medic where eDate >='"+today+"' and quantity >'0'";
            ds = fn.getData(query);
        ...
        private void txtNoOfUnits_TextChanged(object sender, EventArgs e)
        {
            if(txtNoOfUnits.Text !="")
            {
                ...
                Int64 noOfUnit = Convert.ToInt64(txtNoOfUnits.Text);
        ...
        private void btnAddToCart_Click(object sender, EventArgs e)
        {
            if(txtMediId.Text !="")
            {
                ...
                newQuantity = quantity - Convert.ToInt64(txtNoOfUnits.Text);
        ...
        private void guna2DataGridView1_CellClick(object sender, DataGridViewCellEventArgs e)
        {
            try
            {
                ...
                noOfunit = Convert.ToInt64(guna2DataGridView1.Rows[e.RowIndex].Cells[4].Value.ToString());
            }
            catch (Exception) { }
        }
        ...
        private void btnPurchasePrint_Click(object sender, EventArgs e)
        {
            ...
            print.Footer = "Total payment Amount : " + totalLabel.Text;
